...
// Custom Options
class VisualOption extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.newVisuals = !FlxG.save.data.newVisuals;
		display = updateDisplay();
		return true;
	}
	...
	{
		return "Super Effects " + (!FlxG.save.data.newVisuals ? "off" : "on");
	}
}

// low detail mode option
class LowDetail extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.ldm = !FlxG.save.data.ldm;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Low Detail Mode " + (!FlxG.save.data.ldm ? "off" : "on");
	}
}
